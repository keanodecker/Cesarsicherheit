...
export default function ObjektschutzPage() {
  return (
    <div className="min-h-screen pb-20">
      ...
      {/* ── Hero: Gradient Banner mit Titel + Intro ── */}
      <section className="py-16 bg-gradient-to-b from-slate-400 via-[#1e3a5f] to-[#0f1f33]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <SlideIn direction="left">
              <div className="relative h-[320px] rounded-xl overflow-hidden shadow-2xl">
                <Image src="/images/bild-10.jpg" alt="Objektschutz" fill className="object-cover" />
              </div>
            </SlideIn>
      ...
      {/* ── Section 2: Ruhig schlafen ── */}
      <section className="py-20 bg-gradient-to-b from-[#0f1f33] via-[#1e3a5f] to-slate-400">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <SlideIn direction="left">
              <div className="relative h-[420px] rounded-xl overflow-hidden shadow-2xl">
                <Image src="/images/bild-11.jpg" alt="Sicherheitskonzept" fill className="object-cover" />
              </div>
            </SlideIn>
            <SlideIn direction="right" delay={0.2}>
              <div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {["Einbruch","Diebstahl","Beschädigung","Feuer","Sabotage","Werkspionage","Industriespionage"].map((item, i) => (
                    <motion.div key={item} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="flex items-center gap-3">
            ...
            <SlideIn direction="right">
              <div>
                <p className="text-gray-700 mb-6">
                  <strong>Als Kunde von Cesar Sicherheit</strong> können sie sich auf diskreten,
      ...
      <section className="py-20 bg-gradient-to-b from-gray-100 to-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <SlideIn direction="left">
              <div>
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <strong>Diebstählen</strong> wobei immer kleine oder{" "}
                  <strong>größere Sachschäden</strong> entstehen, vermeiden Sie solche unnötigen
            ...
            <SlideIn direction="right" delay={0.2}>
              <div className="relative h-[360px] rounded-xl overflow-hidden shadow-2xl">
                <Image src="/images/bild-12.jpg" alt="Baustellenbewachung" fill className="object-cover" />
              </div>
            </SlideIn>
          </div>
        </div>
