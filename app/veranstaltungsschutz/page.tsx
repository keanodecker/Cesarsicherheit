        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <SlideIn direction="right" delay={0.2}>
              <div>
                <p className="text-gray-700 leading-relaxed mb-6">
                  <strong>Wir führen auf Wunsch</strong> auch gezielte Einlass- und
                  Ausweiskontrollen durch, um so die Einhaltung des{" "}
                  <strong>Jugendschutzgesetzes</strong> auf Ihrem Event sicherzustellen.
                </p>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Gäste einen <strong>VIP-Bereich</strong> an? Kein Problem für Cesar Sicherheit —
