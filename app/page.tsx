...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-10">
              ...
              <Link href="/veranstaltungsschutz" className="group block">
                ...
                <div className="mt-5">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Sie möchten die Sicherheit dieser Veranstaltung gewährleistet wissen und sich einfach
                    entspannt zurücklehnen und den Abend genießen, oder sind anderweitig so eingebunden,
                    dass sie keine Zeit mehr für die Sicherheit finden?
                  </p>
                </div>
              </Link>
            </SlideIn>
            ...
            <SlideIn direction="right" delay={0.2}>
              <Link href="/objektschutz" className="group block">
                ...
                <div className="mt-5">
                  <h3 className="text-2xl font-bold text-white mb-3 flex items-center gap-2 underline decoration-accent underline-offset-4">
                    <Building className="text-accent flex-shrink-0" size={22} />
                    Objektschutz
                  </h3>
                  <p className="text-gray-300 leading-relaxed">
      ...
      {/* ── Testimonials: horizontales Laufband ── */}
      <section className="py-20 bg-gradient-to-b from-gray-300 via-[#1e3a5f] to-[#0f1f33] overflow-hidden">
        ...
        {/* Carousel track — doubled for seamless loop */}
        <div className="overflow-hidden">
          <div className="review-track flex gap-6 w-max">
            {carouselReviews.map((t, i) => (
              <div
                key={`${t.name}-${i}`}
                className="bg-white rounded-xl shadow-lg p-5 flex flex-col gap-3 w-72 flex-shrink-0"
              >
                {/* Header */}
